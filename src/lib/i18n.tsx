...
const en: Translations = {
  ...
  // Profile
  'prof.loginPrompt': 'Please log in to view your profile.',
  'prof.signIn': 'Sign In',
  'prof.needPhotoBio': 'Add a photo and bio to build trust with others!',
  'prof.needPhoto': "Add a profile photo so people know who they're working with!",
  'prof.needBio': 'Write a short bio to help others trust you!',
  'prof.verified': 'Verified',
  'prof.roasted': 'Roasted',
  'prof.rating': 'Rating',
  'prof.reviews': 'Reviews',
  'prof.bravery': 'Bravery',
  'prof.about': 'About',
  'prof.edit': 'Edit',
  'prof.noBio': 'No bio yet — tell people about yourself to build trust!',
  'prof.notSet': 'Not set',
  'prof.streak': 'Streak',
  'prof.days': 'days',
  ...
  'prof.bioLabel': 'Bio — tell people about yourself',
  'prof.bioPhRoaster': "e.g. I've been handling pest control for 3 years. Fast, reliable, and I always get the job done.",
  'prof.bioPhBug': "e.g. I live in a ground floor apartment and need help sometimes. Always respectful and pay on time!",
  'prof.bioHint': 'A good bio helps others feel comfortable working with you.',
  'prof.city': 'City',
  'prof.cityPh': 'e.g. Tel Aviv',
  'prof.socialLabel': 'Social / Profile Link',
  'prof.socialPh': 'e.g. https://instagram.com/yourname',
  'prof.socialHint': "Add a social profile (Instagram, Facebook, LinkedIn…) so others can see you're real — it builds trust and gets you more help and jobs.",
  'prof.paypalLabel': 'PayPal.me Username',
  'prof.paypalPh': 'yourUsername',
  'prof.paypalHint': 'Bugaphobes can send you a "Buy a Coffee" tip after you help them.',
  'prof.radiusLabel': 'Notification Radius',
  'prof.radiusHint': 'Get notified about roach alerts within this distance.',
  'prof.save': 'Save',
  'prof.cancel': 'Cancel',
  'prof.trustSafety': 'Trust & Safety',
  'prof.checkPhoto': 'Profile photo added',
  'prof.checkBio': 'Bio written',
  'prof.checkVerified': 'Identity verified',
  'prof.getVerified': 'Get verified →',
  'prof.checkReviews': 'Has reviews from others',
  'prof.reviewsTitle': 'Reviews',
  'prof.noReviews': 'No reviews yet.',
  'prof.user': 'User',
  'prof.photoUpdated': 'Photo updated!',
...
const he: Translations = {
  ...
  // Profile
  'prof.loginPrompt': 'צריך להתחבר כדי לראות את הפרופיל.',
  'prof.signIn': 'התחברות',
  'prof.needPhotoBio': 'הוסיפו תמונה וכמה מילים על עצמכם כדי לבנות אמון!',
  'prof.needPhoto': 'הוסיפו תמונת פרופיל כדי שאנשים ידעו עם מי הם עובדים!',
  'prof.needBio': 'כתבו כמה מילים על עצמכם כדי שיסמכו עליכם!',
  'prof.verified': 'מאומת',
  'prof.roasted': 'חוסלו',
  'prof.rating': 'דירוג',
  'prof.reviews': 'ביקורות',
  'prof.bravery': 'אומץ',
  'prof.about': 'עליי',
  'prof.edit': 'עריכה',
  'prof.noBio': 'עדיין אין תיאור — ספרו על עצמכם כדי לבנות אמון!',
  'prof.notSet': 'לא הוגדר',
  'prof.streak': 'רצף',
  'prof.days': 'ימים',
  'prof.memberSince': 'חבר/ה מאז',
  'prof.editProfile': 'עריכת פרופיל',
  'prof.displayName': 'שם תצוגה',
  'prof.yourName': 'השם שלכם',
  'prof.bioLabel': 'כמה מילים על עצמכם',
  'prof.bioPhRoaster': 'למשל: אני מטפל בג׳וקים כבר 3 שנים. מהיר, אמין, ותמיד מסיים את העבודה.',
  'prof.bioPhBug': 'למשל: אני גר/ה בדירת קרקע וצריך/ה עזרה מדי פעם. תמיד מכבד/ת ומשלם/ת בזמן!',
  'prof.bioHint': 'תיאור טוב עוזר לאחרים להרגיש בנוח לעבוד איתכם.',
  'prof.city': 'עיר',
  'prof.cityPh': 'למשל: תל אביב',
  'prof.socialLabel': 'קישור לפרופיל חברתי',
  'prof.socialPh': 'למשל: https://instagram.com/yourname',
  'prof.socialHint': 'הוסיפו פרופיל חברתי (אינסטגרם, פייסבוק, לינקדאין…) כדי שיראו שאתם אמיתיים — זה בונה אמון ומביא לכם יותר עזרה ועבודות.',
  'prof.paypalLabel': 'שם משתמש ב-PayPal.me',
  'prof.paypalPh': 'שם המשתמש שלכם',
  'prof.paypalHint': 'ג׳וקופובים יכולים לשלוח לכם טיפ "קנו לי קפה" אחרי שעזרתם להם.',
  'prof.radiusLabel': 'רדיוס התראות',
  'prof.radiusHint': 'קבלו התראה על ג׳וקים במרחק הזה.',
  'prof.save': 'שמירה',
  'prof.cancel': 'ביטול',
  'prof.trustSafety': 'אמון וביטחון',
  'prof.checkPhoto': 'תמונת פרופיל נוספה',
  'prof.checkBio': 'נכתב תיאור',
  'prof.checkVerified': 'הזהות אומתה',
  'prof.getVerified': 'לאימות ←',
  'prof.checkReviews': 'יש ביקורות מאחרים',
  'prof.reviewsTitle': 'ביקורות',
  'prof.noReviews': 'עדיין אין ביקורות.',
  'prof.user': 'משתמש',
  'prof.photoUpdated': 'התמונה עודכנה!',
  'prof.saved': 'הפרופיל נשמר!',
